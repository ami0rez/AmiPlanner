...
namespace Amirez.Infrastructure.Migrations
{
    ...
    [Migration("20220215203755_updatedGoalAndFolder")]
    partial class updatedGoalAndFolder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amirez.Infrastructure.Data.Model.Common.FolderDataModel", b =>
                {
                    ...
                    b.Property<Guid?>("FolderDataModelId")
                        .HasColumnType("TEXT")
                        .HasColumnName("folder_data_model_id");
                    ...
                    b.HasIndex("FolderDataModelId")
                        .HasDatabaseName("ix_folder_folder_data_model_id");
            ...
            modelBuilder.Entity("Amirez.Infrastructure.Data.Model.Common.FolderDataModel", b =>
                {
                    b.HasOne("Amirez.Infrastructure.Data.Model.Common.FolderDataModel", null)
                        .WithMany("Folders")
                        .HasForeignKey("FolderDataModelId")
                        .HasConstraintName("fk_folder_folder_folder_data_model_id");
                });
