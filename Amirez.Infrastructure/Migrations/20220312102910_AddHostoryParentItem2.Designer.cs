...
namespace Amirez.Infrastructure.Migrations
{
    ...
    [Migration("20220312102910_AddHostoryParentItem2")]
    partial class AddHostoryParentItem2
    {
            ...
            modelBuilder.Entity("Amirez.Infrastructure.Data.HistoryDataModel<Amirez.Infrastructure.Data.Model.Common.TaskDataModel>", b =>
                {
                    ...
                    b.Property<Guid?>("TaskDataModelId")
                        .HasColumnType("TEXT")
                        .HasColumnName("task_data_model_id");
                    ...
                    b.HasIndex("TaskDataModelId")
                        .HasDatabaseName("ix_history_task_data_model_id");
            ...
            modelBuilder.Entity("Amirez.Infrastructure.Data.HistoryDataModel<Amirez.Infrastructure.Data.Model.Common.TaskDataModel>", b =>
                {
                    b.HasOne("Amirez.Infrastructure.Data.Model.Common.TaskDataModel", "Parent")
                        ...
                        .HasConstraintName("fk_history_task_parent_id");

                    b.HasOne("Amirez.Infrastructure.Data.Model.Common.TaskDataModel", null)
                        .WithMany("HistoryVersions")
                        .HasForeignKey("TaskDataModelId")
