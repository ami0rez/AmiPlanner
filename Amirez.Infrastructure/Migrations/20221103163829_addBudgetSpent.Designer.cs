...
namespace Amirez.Infrastructure.Migrations
{
    ...
    [Migration("20221103163829_addBudgetSpent")]
    partial class addBudgetSpent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amirez.Infrastructure.Data.Model.Authentication.RoleDataModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ee69dc90-1311-4bb1-b405-22cc6d7de683"),
                            ConcurrencyStamp = "e4192229-31f5-4b5b-be8c-071b493cdc01",
                            Name = "Administrateur",
                            RoleType = 1
                        },
                        new
                        {
                            Id = new Guid("a94159c7-5259-483d-9a7e-54fb08f3de0a"),
                            ConcurrencyStamp = "0d0174a9-c95a-4e9d-9363-1b98f03608fd",
                            Name = "Cb",
                            RoleType = 2
                        },
                        new
                        {
                            Id = new Guid("a1613e9c-ecb5-44fe-9431-4b0bb600d02c"),
                            ConcurrencyStamp = "9f0bb348-45d2-4dad-ad2e-e9ed62407fab",
                            Name = "Ruo",
                            RoleType = 3
                        },
                        new
                        {
                            Id = new Guid("b24de341-855f-40e2-967d-300dc32a4cdb"),
                            ConcurrencyStamp = "9286414c-21b9-4f5c-833a-a2b2067c1cbb",
                            Name = "Superviseur",
                            RoleType = 4
                        });
                });
            ...
            modelBuilder.Entity("Amirez.Infrastructure.Data.Model.Budget.BudgetSpentDataModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_budget_spent");

                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_budget_spent_parent_id");

                    b.ToTable("budget_spent");
                });
            ...
            modelBuilder.Entity("Amirez.Infrastructure.Data.Model.Budget.BudgetSpentDataModel", b =>
                {
                    b.HasOne("Amirez.Infrastructure.Data.Model.Budget.BudgetTrackDataModel", "Parent")
                        .WithMany("Spendings")
                        .HasForeignKey("ParentId")
                        .HasConstraintName("fk_budget_spent_budget_track_parent_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
